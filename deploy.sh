...
usage() {
    ...
    echo "  openbkn install              Install OpenBKN services; auto-installs K8s/data services if missing"
    echo "  openbkn download             Download/update OpenBKN charts into .tmp/charts"
    echo "  openbkn uninstall            Uninstall OpenBKN services"
    echo "  openbkn status               Show OpenBKN services status"
...
confirm_access_address_before_install() {
    ...
    echo ""
    echo "============================================"
    echo "  OpenBKN Access Address Configuration"
    echo "============================================"
